...
def inicio(request):
    ...
    if len(entidades) == 1:#sólo debería de existir la entidad pública
        actores1 = Actores(centros=False,escenarios=False,deportistas=False,personal_apoyo=True,dirigentes=True,cajas=False)
        actores1.save()
        actores2 = Actores(centros=False,escenarios=False,deportistas=False,personal_apoyo=True,dirigentes=True,cajas=False)
        actores2.save()
