...
urlpatterns = patterns('registro_resultados.views.juegos',
    ...
    url(r'^competencia/(\d+)/participantes-posicion$', 'participante_posicion', name='participante_posicion'),
    url(r'^competencia/(\d+)/participantes-posicion/(\d+)$', 'participante_posicion', name='participante_posicion'),
    ...
    url(r'^competencia/(\d+)/equipo-posicion$', 'equipo_posicion', name='equipo_posicion'),
    url(r'^competencia/(\d+)/equipo-posicion/(\d+)$', 'equipo_posicion', name='equipo_posicion'),
