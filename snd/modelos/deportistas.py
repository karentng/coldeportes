...
class HistorialDeportivo(models.Model):
    ...
    modalidad = models.ForeignKey(ModalidadDisciplinaDeportiva,blank=True,verbose_name='Modalidad de competencia')
    division = models.CharField(max_length=100,blank=True,verbose_name='División de competencia')
    deporte = models.ForeignKey(TipoDisciplinaDeportiva,blank=True,verbose_name='Deporte en el que participó')
    categoria = models.ForeignKey(CategoriaDisciplinaDeportiva,blank=True,verbose_name='Categoría en la que participó')
