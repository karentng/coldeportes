...
urlpatterns = patterns('entidades.views',
	...
	url(r'^entrenadores/ver/(\d+)/([\w\-]+)$', 'ver_entrenador_tenantnacional', name='ver_entrenador_tenantnacional'),
	...
	url(r'^escenarios/ver/(\d+)/([\w\-]+)$', 'ver_escenario_tenantnacional', name='ver_escenario_tenantnacional'),
	...
	url(r'^cajas-compensacion/ver/(\d+)/([\w\-]+)$', 'ver_caja_tenantnacional', name='ver_caja_tenantnacional'),
