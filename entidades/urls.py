...
urlpatterns = patterns('entidades.views',
    ...
    #TEMPORAL DISCIPLINAS Y CATEGORIAS
    url(r'^modalidades$', 'listar_modalidades', name='listar_modalidades'),
    url(r'^modalidades/crear$', 'crear_editar_mod', name='crear_editar_mod'),
    url(r'^modalidades/editar/(\d+)$', 'crear_editar_mod', name='crear_editar_mod'),
