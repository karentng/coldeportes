...
INSERT INTO entidad1.snd_caracterizacionescenario_caracteristicas (id, caracterizacionescenario_id, caracteristicaescenario_id) VALUES
(15,	2,	2),
(16,	2,	3),
(17,	2,	22),
(18,	1,	21),
...
INSERT INTO entidad1.snd_caracterizacionescenario_clase_uso (id, caracterizacionescenario_id, tipousoescenario_id) VALUES
(8,	2,	2),
(9,	1,	1),
(10,	3,	1);

INSERT INTO entidad1.snd_caracterizacionescenario_tipo_disciplinas (id, caracterizacionescenario_id, tipodisciplinadeportiva_id) VALUES
(15,	2,	4),
(16,	2,	6),
(17,	1,	2),
(18,	3,	4);

INSERT INTO entidad1.snd_caracterizacionescenario_tipo_superficie_juego (id, caracterizacionescenario_id, tiposuperficie_id) VALUES
(9,	2,	2),
(10,	1,	10),
(11,	3,	3);

INSERT INTO entidad1.snd_horariodisponibilidad (id, hora_inicio, hora_fin, descripcion, escenario_id) VALUES
...
INSERT INTO entidad1.snd_horariodisponibilidad_dias (id, horariodisponibilidad_id, dias_id) VALUES
(1,	1,	2),
(2,	1,	3),
(3,	1,	4),
(4,	1,	5),
...
INSERT INTO entidad1.snd_datohistorico (id, fecha_inicio, fecha_fin, descripcion, escenario_id) VALUES
...
INSERT INTO entidad1.snd_contacto (id, nombre, telefono, email, escenario_id, descripcion) VALUES
