...
urlpatterns = patterns('',
    ...
    url(r'^reconocimiento-deportivo/', include('reconocimiento_deportivo.urls.solicitudes')),
    url(r'^reconocimiento-deportivo/', include('reconocimiento_deportivo.urls.respuestas')),
